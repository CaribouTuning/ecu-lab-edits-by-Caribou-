...
export const PAGE_GUIDES = {
  ...
  nitrous: {
    does: 'When the nitrous sprays — the RPM, throttle and coolant window — how much timing comes out while it does, a dry kit\'s fuel, and a progressive ramp-in.',
    when: 'As soon as a kit is fitted on BUILD, and whenever the Pull Log shows knock or a lean cut while spraying.',
