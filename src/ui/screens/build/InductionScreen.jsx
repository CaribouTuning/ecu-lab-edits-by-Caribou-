      ...
      <div className={styles.subPanel} data-open={turboOn ? 'true' : 'false'}>
        <div className={styles.subPanelInner}>
          {turboOn && Math.max(...boostCurve) <= 0 && (
            <Note>
              The boost target is 0 psi everywhere, so the turbo only restricts the exhaust and the engine makes less power, not more. Set a boost curve under Boost Target Curve below; 6–8 psi is a safe first step.
            </Note>
          )}
