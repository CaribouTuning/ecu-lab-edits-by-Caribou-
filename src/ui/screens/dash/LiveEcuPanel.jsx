    ...
    <Panel style={{ background: T.panel, marginBottom: 10 }}>
      ...
      {row && live.running ? (
        <div className={styles.tiles}>
          ...
          {kit && <StatTile label="Bottle" value={String(row.bottle)} unit="psi" tone={row.bottle < 850 ? 'warn' : 'neutral'} />}
        </div>
      ) : (
      ...
      <div className={styles.loads}>
        ...
        {kit && (
          <Toggle label="Nitrous armed" sub={`${kit.shotHp} shot ${kit.kit} kit — sprays at full throttle inside the window set on TUNE › NITROUS${row ? `; bottle at ${row.bottle} psi` : ''}`}
