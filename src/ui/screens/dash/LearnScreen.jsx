  ...
  return (
    ...
    >
      ...
      <ExpandableInfo title="41. Nitrous oxide: oxygen from a bottle">
        ...
        <br /><br /><b className={styles.em}>The bottle.</b> Nitrous is stored as a liquid under its own vapour pressure, set by temperature, not by how full it is: about 590 psi at 50 °F, 760 at 70 °F, 920 at 85 °F. The jets are sized for 900–950 psi, so a cold bottle flows short. Spraying boils off some of what is left and cools the bottle, so pressure falls through a pass. That is why racers run bottle heaters. A wet kit&apos;s fuel does not follow the bottle, so it runs rich when the bottle is cold and lean when it is hot.
