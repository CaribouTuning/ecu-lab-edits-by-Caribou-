  ...
  return (
    ...
    >
      ...
      <ExpandableInfo title="29. Why the engine sounds the way it does">
        ...
        <br /><br /><b className={styles.em}>The muffler takes the top off.</b> Because a pipe radiates how fast the flow changes, every event leans towards the treble. Packing in the muffler absorbs that and leaves the boom. A straight-through cat-back absorbs less, so it sounds brighter; a turbine in the path takes work out of every pulse and smears what is left, which is why a turbo engine sounds muted.
