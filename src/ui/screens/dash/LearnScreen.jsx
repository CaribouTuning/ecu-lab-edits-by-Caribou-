  ...
  return (
    ...
    >
      ...
      <ExpandableInfo title="29. Why the engine sounds the way it does">
        ...
        <br /><br /><b className={styles.em}>Why full throttle barks and idle thuds.</b> A small pressure wave travels at the speed of sound. A big one does not: the gas in its crest is moving fast, so the crest travels faster than the base and catches up with the front. Over a metre or two of pipe a full-load pulse sharpens towards a shock wave, and a sharp front is full of high harmonics — that is the bark, the crack, the rasp. At idle the pulses are too small to steepen, so they arrive as soft thuds. The app runs every pulse down its primary this way, so the same engine sounds different at idle, cruising and flat out, as a real one does.
