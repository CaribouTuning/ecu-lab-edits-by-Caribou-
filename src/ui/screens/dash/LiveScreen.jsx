        ...
        <div className={styles.head}>
          ...
          <div className={styles.column}>
            <div className={styles.status}>
              {live.running
                ? (live.limiterCut || live.onLimiter ? 'On the rev limiter — the ECU is cutting fuel to hold the engine at its limit. Cut cylinders pump plain air, so the wideband reads lean here; that is not a lean mixture.'
