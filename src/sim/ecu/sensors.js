 ...
 * @type {Record<string, Record<string, {label: string, min: number, max: number}>>}
 */
export const LINEAR_SCALES = {
  ...
  wideband: {
    'lambda-0.5-1.5': { label: 'λ 0.50–1.50 (0–5 V)', min: 0.5, max: 1.5 },
    'afr-10-20': { label: 'AFR 10–20 gasoline (0–5 V)', min: 10 / 14.7, max: 20 / 14.7 },
    'afr-7.3-22.4': { label: 'AFR 7.3–22.4 gasoline (0.5–4.5 V)', min: 7.31 / 14.7, max: 22.39 / 14.7 },
  },
  fuelPressure: {
