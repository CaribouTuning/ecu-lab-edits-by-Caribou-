...
import { N2O, N2O_AIR_EQUIV, latentHeatJPerKg, perCylinderEvent } from './nitrous.js';
 ...
 * @property {{n2oKgS: number, fuelKgS?: number, bottleK: number, bottlePsi?: number}} [nitrous]
 ...
 *   meters for the air — a dry nitrous kit's fuel, through the injectors
...
export function evaluatePoint({
  ...
  if (n2o) {
    cylChargeK = chargeK - (n2o.n2oG * latentHeatJPerKg(nitrous.bottleK) * COEFF.N2O_CHARGE_COOLING_SHARE)
      / (airChargeG * COEFF.CHARGE_CP);
