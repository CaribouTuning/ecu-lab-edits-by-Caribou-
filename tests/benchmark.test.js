 ...
 * - HEYWOOD: J. B. Heywood, Internal Combustion Engine Fundamentals (2nd ed., 2018).
 ...
 * - PCP: 120 bar typical for boosted SI, 140 bar for the latest TGDI designs.
 *
 * @type {Record<string, [number, number]>}
 */
const REAL = {
  // Best-power enrichment. NA calibrations run lambda 0.85-0.88 at full load; boosted
  // ones richer, for charge and turbine cooling (HEYWOOD ch. 7; OEM WOT logs).
  lambdaNa: [0.84, 0.90],
  ...
  hpPerLbMin: [9.0, 12.5],
  // 50% mass burned at MBT: 8-10 degrees ATDC across engine types (HEYWOOD fig. 9-4).
  mfb50AtMbt: [6, 12],
  ...
  egtNa: [700, 900],
  egtBoosted: [740, 980],
  // Peak cylinder pressure, bar (PCP; HEYWOOD ch. 9).
  pmaxNa: [45, 90],
  pmaxBoosted: [60, 140],
  // Brake mean effective pressure at peak torque, bar. Modern NA 11-14; downsized
  // turbo 17-27 (HEYWOOD; published torque ÷ displacement).
  bmepNa: [11, 14.5],
  bmepBoosted: [15, 27],
  // Friction plus pumping at peak power, bar (HEYWOOD ch. 13, modern engines).
  fmep: [0.8, 3.0],
};
